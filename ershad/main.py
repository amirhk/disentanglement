...
def vae_loss(x, _x_decoded):
    ...
    xent_loss_1 = original_dim * objectives.binary_crossentropy(x_1, _x_decoded_1)
    xent_loss_2 = original_dim * objectives.binary_crossentropy(x_2, _x_decoded_2)
...
y_test_label = np.tile(y_test_label,(1,2))
