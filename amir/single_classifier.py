...
# vaeencoder = Model(inputs = [x_1], outputs = [_y_decoded_1_])
vaeencoder = Model(inputs = [x_2], outputs = [_y_decoded_2_])
...
class ACCURACY(Callback):
    ...
    def on_epoch_end(self,batch,logs = {}):
        ...
        pickle.dump((ii),open('counter', 'wb'))
        with open(text_file_name, 'a') as text_file:
          print('Epoch #{} Accuracy SVHN:{} \n'.format(ii, ACC_2), file=text_file)
